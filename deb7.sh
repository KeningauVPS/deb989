...
# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://insomnet4u.me/CrotD/openvpn.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://insomnet4u.me/CrotD/1194-debian.conf"
service openvpn restart
sysctl -w net.ipv4.ip_forward=1
sed -i 's/#net.ipv4.ip_forward=1/net.ipv4.ip_forward=1/g' /etc/sysctl.conf
wget -O /etc/iptables.up.rules "https://insomnet4u.me/CrotD/iptables.up.rules"
...
#konfigurasi openvpn
cd /etc/openvpn/
wget -O /etc/openvpn/client.ovpn "https://insomnet4u.me/CrotD/1194-client.conf"
sed -i $MYIP2 /etc/openvpn/client.ovpn;
PASS=`cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w 15 | head -n 1`;
useradd -M -s /bin/false admin_ibnu
echo "aink:$PASS" | chpasswd
cp client.ovpn /home/vps/public_html/

# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://insomnet4u.me/CrotD/badvpn-udpgw"
sed -i '$ i\screen -AmdS badvpn badvpn-udpgw --listen-addr 127.0.0.1:7300' /etc/rc.local
chmod +x /usr/bin/badvpn-udpgw
screen -AmdS badvpn badvpn-udpgw --listen-addr 127.0.0.1:7300

# install mrtg
wget -O /etc/snmp/snmpd.conf "https://insomnet4u.me/CrotD/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://insomnet4u.me/CrotD/mrtg-mem.sh"
...
curl "https://insomnet4u.me/CrotD/mrtg.conf" >> /etc/mrtg.cfg
